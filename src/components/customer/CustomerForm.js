...
import {saveCustomer, fetchStore} from '../../actions/actions';
...
class CustomerForm extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    if (isValid) {
      ...
      this.props.saveCustomer({ storeId, firstName, lastName, phone, emailId }).then(
        () => { 
          this.props.fetchStore().then(() => {
              this.setState({ 
                  done: true 
                  }) 
        })
...
export default connect(null, { saveCustomer, fetchStore })(CustomerForm);
